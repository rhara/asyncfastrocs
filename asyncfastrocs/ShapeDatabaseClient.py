...
def main(argv=[__name__]):
    ...
    parser.add_argument('server:port',
                        help='Server name and port number of database to search i.e. localhost:8080.')
    parser.add_argument('query',
                        help='File containing the query molecule to search (format not restricted to *.oeb).')
    ...
    parser.add_argument('--alternativeStarts', default=argparse.SUPPRESS, nargs=1, dest='altStarts',
                        choices=('random', 'subrocs', 'inertialAtHeavyAtoms', 'inertialAtColorAtoms'),
    ...
    try:
        ...
        if "TypeError" in e.faultString:
            ...
            if ((iformat == ".oeb" or iformat == ".sq") and oformat == ".oeb"):
                ...
                sys.stderr.write("This client will work with this version of the server if the input file is either"
